...
namespace EMSC
{
    public partial class DB_Location : Form
    {
        ...
        private void URL_Test_Click(object sender, EventArgs e)
        {
            ...
            string connectionString = @"Provider=Microsoft.ACE.OLEDB.12.0;Data Source=" + URL_Link.Text;
        ...
        private void URL_Save_Click(object sender, EventArgs e)
        {
            ...
            Properties.Settings.Default.UpdateLink = UpdateLink.Text;
        ...
        private void DB_Location_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        private void UpdateLink_TextChanged(object sender, EventArgs e)
        {
            UpdateLink.Text = UpdateLink.Text.Replace("\"", "");
        }
    }
}
