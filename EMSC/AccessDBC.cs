...
namespace EMSC
{
    class AccessDBC
    {
        ...
        {//I need to specify whay of connection (read only or write) through each function
            connectionStringW = @"Provider=Microsoft.ACE.OLEDB.12.0;Data Source=" + connection_str;
            connectionStringR = @"Provider=Microsoft.ACE.OLEDB.12.0;Data Source=" + connection_str;
        }
        ...
        public object Get_single_Data(Dictionary<string, string> dict, string table_name, string col_name)
        {//this function will take 
            /*
            as input ductionary represent filter col-value
            also table name
            ...
            */
            ...
            OleDbConnection con = new OleDbConnection(Properties.Settings.Default.LocalDB);
            List<string> str_list = new List<string>();
            //here i will do something to make this code more dynamic
            //I will make selection will based on 
            OleDbCommand cmd = new OleDbCommand(command_str, con);
