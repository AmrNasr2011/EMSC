...
namespace EMSC
{
    class AccessDB
    {
        ...
        public AccessDB()
        {
            ...
            //catch (Exception)
            //{
            connection_str = app_loc + "\\MV.accdb";
            //MessageBox.Show("Missing connection string file");
            //}
            //connectionString = @"Provider=Microsoft.ACE.OLEDB.12.0;Data Source=D:\Study\Personal Work\schnider\tasks\E2P\E2P_Application\E2P.accdb";
            connectionString = @"Provider=Microsoft.ACE.OLEDB.12.0;Data Source=" + connection_str;
        }
